...
# 想按line推理，请设sep='\n'；如果为其他，则整句话一次推理
chunk_json_path_list = split_book_into_chunk(file_path, chunk_size=300, output_dir=output_dir, sep='')
# print(chunk_json_path_list)
...
ref_wav_path = 'ref_wav/正常说话 なんでこんな枯れてんのかわかんないんだけどまじめちゃくちゃ.wav'
